<template>
  <div class="successPage" v-if="order">
    <div class="container">
      <h1>Заказ оформлен</h1>

    <!-- http://localhost:3000/checkout/success?orderId=9bb469b4-9ff7-7824-ab53-844800c747a7&lang=ru -->
...
export default {
  head() {
    return meta({
      title: "Заказ успешно оформлен. Интернет-магазин корейской косметики, купить корейскую косметику в Минске - Voditsa.by",
      description: "Заказ успешно оформлен на сайте интернет-магазина корейской косметики voditsa.by. Купить косметику в интернет-магазине Voditsa. ❤️ Популярные бренды корейской косметики. ⭐ Выгодные цены. ⭐ Скидки и акции. ✔️ Доставка по Минску и Беларуси.",
    }, null, this);
  },
  data() {
    return {
